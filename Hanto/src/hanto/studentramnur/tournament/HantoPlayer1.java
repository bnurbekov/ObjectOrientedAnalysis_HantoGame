 ...
 *
 */
public class HantoPlayer1 implements HantoGamePlayer {
	...
	public void startGame(HantoGameID version, HantoPlayerColor myColor,
		...
		results.add(new HantoMoveRecord(CRAB, null, new HantoBoardCoordinate(0, 0)));
		results.add(new HantoMoveRecord(SPARROW, null, new HantoBoardCoordinate(0, -1)));
		results.add(new HantoMoveRecord(BUTTERFLY, null, new HantoBoardCoordinate(-1, -1)));
		results.add(new HantoMoveRecord(SPARROW, null, new HantoBoardCoordinate(-1, 1)));
		results.add(new HantoMoveRecord(SPARROW, new HantoBoardCoordinate(-1, 1), new HantoBoardCoordinate(3, 1)));
		results.add(new HantoMoveRecord(CRAB, null, new HantoBoardCoordinate(4, 1)));
		results.add(new HantoMoveRecord(CRAB, null, new HantoBoardCoordinate(5, 1)));
		results.add(new HantoMoveRecord(CRAB, null, new HantoBoardCoordinate(6, 1)));
		results.add(new HantoMoveRecord(CRAB, null, new HantoBoardCoordinate(4, 2)));
		results.add(new HantoMoveRecord(CRAB, null, new HantoBoardCoordinate(5, 2)));
		results.add(new HantoMoveRecord(HORSE, null, new HantoBoardCoordinate(6, 2)));
		results.add(new HantoMoveRecord(HORSE, null, new HantoBoardCoordinate(7, 2)));
		results.add(new HantoMoveRecord(HORSE, null, new HantoBoardCoordinate(7, 1)));
		results.add(new HantoMoveRecord(HORSE, null, new HantoBoardCoordinate(5, 3)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(6, 1), new HantoBoardCoordinate(6, 0)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(6, 0), new HantoBoardCoordinate(6, 1)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(7, 1), new HantoBoardCoordinate(1, 1)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(1, 1), new HantoBoardCoordinate(7, 1)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(6, 2), new HantoBoardCoordinate(4, 4)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(7, 2), new HantoBoardCoordinate(7, 0)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(7, 0), new HantoBoardCoordinate(4, 3)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(4, 3), new HantoBoardCoordinate(7, 0)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(7, 0), new HantoBoardCoordinate(4, 3)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(5, 3), new HantoBoardCoordinate(5, 0)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(5, 0), new HantoBoardCoordinate(5, 3)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(4, 2), new HantoBoardCoordinate(3, 2)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(3, 2), new HantoBoardCoordinate(4, 2)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(4, 3), new HantoBoardCoordinate(6, 3)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(4, 2), new HantoBoardCoordinate(4, 3)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(4, 3), new HantoBoardCoordinate(3, 4)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(3, 4), new HantoBoardCoordinate(4, 3)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(4, 3), new HantoBoardCoordinate(3, 4)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(3, 4), new HantoBoardCoordinate(4, 3)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(4, 3), new HantoBoardCoordinate(3, 4)));
		results.add(new HantoMoveRecord(SPARROW, new HantoBoardCoordinate(0, -1), new HantoBoardCoordinate(3, 0)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(6, 3), new HantoBoardCoordinate(4, 3)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(5, 3), new HantoBoardCoordinate(3, 3)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(7, 1), new HantoBoardCoordinate(2, 1)));
		results.add(new HantoMoveRecord(SPARROW, new HantoBoardCoordinate(3, 0), new HantoBoardCoordinate(2, 4)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(6, 1), new HantoBoardCoordinate(6, 2)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(3, 3), new HantoBoardCoordinate(1, 5)));
		results.add(new HantoMoveRecord(CRAB, new HantoBoardCoordinate(6, 2), new HantoBoardCoordinate(5, 3)));
		results.add(new HantoMoveRecord(HORSE, new HantoBoardCoordinate(4, 3), new HantoBoardCoordinate(2, 5)));
		results.add(new HantoMoveRecord(SPARROW, new HantoBoardCoordinate(2, 4), new HantoBoardCoordinate(1, 1)));
		results.add(new HantoMoveRecord(SPARROW, new HantoBoardCoordinate(1, 1), new HantoBoardCoordinate(2, 0)));
	}
